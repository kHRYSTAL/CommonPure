package com.yimeiduo.business.widget;
...
//    private static final int TO_SHRINK_HINT_COLOR = 0xFFE74C3C;
    ...
    private void init() {
        ...
        if(TextUtils.isEmpty(mToExpandHint)){
            mToExpandHint = getResources().getString(R.string.desc_spread);
        }
        if(TextUtils.isEmpty(mToShrinkHint)){
            mToShrinkHint = getResources().getString(R.string.desc_shrinkup);
        }
        if(mToggleEnable){

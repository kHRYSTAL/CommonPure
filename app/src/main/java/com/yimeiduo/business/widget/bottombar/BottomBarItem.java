package com.yimeiduo.business.widget.bottombar;
...
public class BottomBarItem extends LinearLayout {
    ...
    private void initAttrs(TypedArray ta) {
        ...
        titleTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemTextSize, UIUtil.sp2px(context, titleTextSize));

        titleNormalColor = ta.getColor(R.styleable.BottomBarItem_textColorNormal, UIUtil.getColor(context, R.color.bbl_999999));
        titleSelectedColor = ta.getColor(R.styleable.BottomBarItem_textColorSelected, UIUtil.getColor(context, R.color.bbl_ff0000));

        marginTop = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemMarginTop, UIUtil.dip2Px(context, marginTop));
        ...
        unreadTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_unreadTextSize, UIUtil.sp2px(context, unreadTextSize));
        unreadTextColor = ta.getColor(R.styleable.BottomBarItem_unreadTextColor, UIUtil.getColor(context, R.color.white));
        unreadTextBg = ta.getDrawable(R.styleable.BottomBarItem_unreadTextBg);

        msgTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_msgTextSize, UIUtil.sp2px(context, msgTextSize));
        msgTextColor = ta.getColor(R.styleable.BottomBarItem_msgTextColor, UIUtil.getColor(context, R.color.white));
    ...
    public void setNormalIcon(int resId) {
        setNormalIcon(UIUtil.getDrawable(context, resId));
    }
    ...
    public void setSelectedIcon(int resId) {
        setSelectedIcon(UIUtil.getDrawable(context, resId));
    }
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            this.context = context;
            titleTextBold = false;
            titleTextSize = UIUtil.sp2px(context, 12);
            titleNormalColor = getColor(R.color.bbl_999999);
            titleSelectedColor = getColor(R.color.bbl_ff0000);
            unreadTextSize = UIUtil.sp2px(context, 10);
            msgTextSize = UIUtil.sp2px(context, 6);
        ...
        public Builder titleTextSize(int titleTextSize) {
            this.titleTextSize = UIUtil.sp2px(context, titleTextSize);
            return this;
        }
        ...
        public Builder unreadTextSize(int unreadTextSize) {
            this.unreadTextSize = UIUtil.sp2px(context, unreadTextSize);
            return this;
        }
        ...
        public Builder msgTextSize(int msgTextSize) {
            this.msgTextSize = UIUtil.sp2px(context, msgTextSize);
            return this;
        }
        ...
        public BottomBarItem create(int normalIconId, int selectedIconId, String text) {
            return create(UIUtil.getDrawable(context, normalIconId), UIUtil.getDrawable(context, selectedIconId), text);
        }
